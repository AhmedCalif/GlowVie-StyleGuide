        ...
        <div className="max-w-6xl mx-auto flex flex-col gap-12">
          <div className="space-y-6 text-center md:text-left">
            ...
            <p className="text-[#0E233B] text-2xl">
              For GlowVie we are going to use the Comfortaa Font. Comfortaa is a
              modern and easy to use font that represents our brand aesthethics
            </p>
          </div>

          <div className="bg-white/80 rounded-xl p-8 shadow-lg backdrop-blur-sm">
            <div className="space-y-6 mb-12">
              <h3 className="text-2xl font-bold text-[#0E233B] mb-8">
                Font Weights
              </h3>
